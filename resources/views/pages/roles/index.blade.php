    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header">
                <h1 class="page-title my-auto">Roles</h1>
                <div>
                        ...
                        <div class="card-body">
                            <div class="team-header">
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="h5 fw-semibold mb-sm-0">Roles</div>
                                    <div class="d-flex align-items-center">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Search Role" aria-describedby="search-team-member">
                                ...
                                <div class="d-flex text-center justify-content-between mt-1 mb-3">
                                    <div class="flex-fill">
                                        ...
                                        <p class="mb-0 fs-12 text-muted text-truncate max-w-150 mx-auto">
                                            Role: <span class="role-name-upper"></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="btn-list d-flex justify-content-center">
                                    @canOrRole('role.edit')
                                        <a class="btn btn-sm btn-icon btn-secondary-light p-0 action-edit d-flex" title="Edit">
                                            <i data-lucide="square-pen" style="width: 1rem; height: 1rem;" class="role-card-icon m-auto text-info"></i>
                                        </a>
                                        <a class="btn btn-sm btn-icon btn-primary-light p-0 action-edit-permissions d-flex" title="Edit Permission">
                                            <i data-lucide="key-round" style="width: 1rem; height: 1rem;" class="role-card-icon m-auto"></i>
                                        </a>
                                    @endcanOrRole

                                    @canOrRole('role.delete')
                                        <a class="btn btn-sm btn-icon btn-danger-light p-0 action-delete d-flex" title="Delete">
                            ...
                            <div class="card-footer border-block-start-dashed text-center p-0">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="d-flex p-3 w-100 justify-content-center border-end">
                                        <div class="text-center">
                                            <p class="fw-semibold mb-0">Members</p>
